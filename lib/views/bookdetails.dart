...
class _BookDetailsState extends State<BookDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.user.id == widget.book.userId) {
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          PopupMenuButton(itemBuilder: (context) {
            ...
            if (value == 0 && widget.book.userId == widget.user.id) {

              if (widget.book.userId == widget.user.id) {
        ...
        child: Column(children: [
          ...
          SizedBox(
            ...
            child: Image.network(
                ...
                "${MyServerConfig.server}/BookBytes/images/products/${widget.book.bookId}.png"),
